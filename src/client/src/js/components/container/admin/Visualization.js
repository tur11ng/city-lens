...
export class Visualization extends Component {
    ...
    toggleHourSelect(e) {
        ...
        if (!e.target.checked) {
            ...
            this.setState({fromHour: this.state.fromHour1, toHour: this.state.toHour1})
        }
    };
            ...
            <Container fluid="md" className="text-center">
                ...
                <form>
                    <Row className="justify-content-center">
                        <Col>
                            <select id="activitiesTypes" className="selectpicker" multiple data-actions-box="true"
                                    onChange={this.activitiesTypesChanged} title="Select activities...">
                                <option>STILL</option>
                    ...
                    <Row className="justify-content-center">
                        ...
                        <Col sm="9" md="4">
                            <div className="form-check form-check-inline">
                                <input className="form-check-input" type="checkbox" id="inlineCheckbox2"
                                       value="option2" onChange={this.toggleDOWSelect} defaultChecked/>
                                <label className="form-check-label" htmlFor="inlineCheckbox2">Filter by day of
                                    week</label>
                            </div>
                        </Col>
                        ...
                        <Col sm="9" md="4">
                            <div className="form-check form-check-inline">
                                ...
                                <label className="form-check-label" htmlFor="inlineCheckbox3">Filter by hour</label>
                            </div>
                        </Col>
                    </Row>
                    <Row className="justify-content-center">
                        ...
                        <Col sm="9" md="4">
                            <select id="fromDOW" className="selectpicker" onChange={this.fromDOWChanged}
                                    title="From week...">
                                {this.buildDay()}
                            </select>
                        </Col>
                        <Col sm="9" md="4">
                            <select id="fromHour" className="selectpicker" onChange={this.fromHourChanged}
                                    title="From hour...">
                                {this.buildHour()}
                            </select>
                        </Col>
                    ...
                    <Row className="justify-content-center">
                        ...
                        <Col sm="9" md="4">
                            <select id="toDOW" className="selectpicker" onChange={this.toDOWChanged} title="To week...">
                                {this.buildDay()}
                            </select>
                        </Col>
                        <Col sm="9" md="4">
                            <select id="toHour" className="selectpicker" onChange={this.toHourChanged}
                                    title="To hour...">
                                {this.buildHour()}
                            </select>
                        </Col>
                ...
                <form>
                    <Row className="justify-content-center">
                        <select id="exportFormat" className="selectpicker" title="Select export format..."
