        ...
        <div className="text-center">
            ...
            <Container fluid="md">
                <Row className="justify-content-md-center">
                    <Col md="4" lg="3"><h5>Activities per hour</h5><ActivitiesPerHour/></Col>
                    <Col md="4" lg="3"><h5>Activities per day of week</h5><ActivitiesPerDOW/></Col>
                    <Col md="4" lg="3"><h5>Activities per month</h5><ActivitiesPerMonth/></Col>
                    <Col md="4" lg="3"><h5>Activities per year</h5><ActivitiesPerYear/></Col>
                </Row>
                <hr/>
                <Row className="justify-content-md-center">
