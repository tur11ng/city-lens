...
export class Login extends Component {
    ...
    validateLoginForm = () => {
        ...
        errors.password = !!(formData.password !== undefined && validator.isEmpty(formData.password));
                    ...
                    <Form onSubmit={this.login}>
                        ...
                        <Form.Group controlId="email">
                            <Form.Control required type="text" name="email" placeholder="Email address"
                                          ...
                                          isInvalid={(errors.email && changed.email) || formInvalid}/>
                            <Form.Control.Feedback type="invalid">Please enter a valid email</Form.Control.Feedback>
                        </Form.Group>
                        <Form.Group controlId="password">
                            <Form.Control required type="password" name="password" placeholder="Password"
                                          onChange={this.handleInputChange}
                                          isInvalid={(errors.password && changed.password) || formInvalid}/>
