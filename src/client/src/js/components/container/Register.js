...
export class Register extends Component {
  ...
  validateRegisterForm = (e) => {
    ...
    errors.name = !!(formData.name !== undefined &&
    ...
    errors.password = formData.password !== undefined &&
      !schema.validate(formData.password)
    ...
    return (
      <div className="Register">
        <Form onSubmit={this.register}>
          ...
          <Form.Group>
            <Form.Control required type="password" name="passwordRetype"
                          placeholder="Retype password"
                          onChange={this.handleInputChange}
                          isInvalid={(errors.email && changed.email) ||
                          formSubmitted}/>
          </Form.Group>
          <Button type="submit" bsStyle="primary" size="lg"
