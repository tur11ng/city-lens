...
class Api {
    ...
    mostRecordsByDOWPerActivity = (params) => {
        return instance.get('/user/activities/most-records-by-dow-per-activity', {params:params});
    };

    mostRecordsByHourPerActivity = (params) => {
        return instance.get('/user/activities/most-records-by-hour-per-activity', {params:params});
    };
