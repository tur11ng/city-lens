...
export class Visualization extends Component {
  ...
  toggleMonthSelect (e) {
    ...
    if (!e.target.checked) {
      ...
      this.setState(
        { fromMonth: this.state.fromMonth1, toMonth: this.state.toMonth1 })
    }
  };
      ...
      <Container fluid="md" className="text-center">
        ...
        <form>
          <Row className="justify-content-center">
            ...
            <Col sm="9" md="6">
              <div className="form-check form-check-inline">
                <input className="form-check-input" type="checkbox"
                       id="inlineCheckbox2"
                       value="option2" onChange={this.toggleMonthSelect}
                       defaultChecked/>
          ...
          <Row className="justify-content-center">
            ...
            <Col sm="10" md="8" lg="6">
              <select id="fromMonth" className="selectpicker"
                      onChange={this.fromMonthChanged}
                      title="From month...">
                {this.buildMonth()}
              </select>
            </Col>
          ...
          <Row className="justify-content-center">
            ...
            <Col sm="10" md="8" lg="6">
              <select id="toMonth" className="selectpicker"
                      onChange={this.toMonthChanged}
                      title="To month...">
                {this.buildMonth()}
              </select>
            </Col>
