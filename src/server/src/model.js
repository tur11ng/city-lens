...
const ActivityProperties = new Schema({
    ...
    type: {
        type: String,
        enum: ['STILL', 'ON_FOOT', 'WALKING', 'ON_BICYCLE', 'IN_VEHICLE', 'TILTING', 'EXITING_VEHICLE'],
        required: true
    },
    confidence: {
        type: Number,
...
mongoose.connect('mongodb://user:password@city-lens-storage:27017/city-lens', {useNewUrlParser: true});
...
let activityProperties = mongoose.model('ActivityProperties', ActivityProperties);
